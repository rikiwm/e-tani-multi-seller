...
if (isset($_POST["tambahGaleriFarm"])) {
  if (tambahGaleriFarm($_POST) > 0) {
    echo "<script>
            alert('Gallery Berhasil Ditambahkan');
            document.location.href = '?page=galeri';
          </script>";
  } else {
    echo "<script>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <label for="name">Nama Gakeri</label>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="desc" name="desc" placeholder="Write something.."></textarea>
                  </div>
                </div>
                <div class="row">
