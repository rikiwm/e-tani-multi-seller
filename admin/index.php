...
<html lang="en">
  <head>
    ...
    <title>Dashboard | E-TANI KOTA SOLOK</title>
      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          <div class="sidebar-heading text-center">
            <img src="../assets/images/lgo.jpg" alt="" class="my-4 w-50" />
          </div>
          <div class="list-group list-group-flush">
            ...
            <a
              href="?page=galeri"
              class="list-group-item list-group-item-action<?= $page == 'galeri' ? ' active' : ''; ?> 
              <?= $page == 'galeri-add' ? ' active' : ''; ?> <?= $page == 'galeri-details' ? ' active' : ''; ?>"
            >
              Galleries
            </a>
            <!-- <a
            ...
            <a
              href="?page=tani"
              class="list-group-item list-group-item-action<?= $page == 'tani' ? ' active' : ''; ?> 
              <?= $page == 'tani-create' ? ' active' : ''; ?>
               <?= $page == 'tani-details' ? ' active' : ''; ?>
                <?= $page == 'tani-delete' ? ' active' : ''; ?>"
            >
              Petani
            </a>
            <a
        ...
        <div id="page-content-wrapper">
          ...
          if (isset($page)) {
            if ($page == 'dashboard') {
              ...
              include 'galeri/dashboard-galeri.php';
            } elseif ($page == 'galeri-add') {
              include 'galeri/dashboard-galeri-add.php';
            } elseif ($page == 'galeri-details') {
              include 'galeri/dashboard-galeri-details.php';
            } elseif ($page == 'galeri-delete') {
              include 'dashboard-galeri-delete.php';
              ...
              include 'tani/dashboard-tani.php';
            } elseif ($page == 'tani-create') {
              include 'tani/dashboard-tani-create.php';
            } elseif ($page == 'tani-details') {
              include 'tani/dashboard-tani-details.php';
            } elseif ($page == 'tani-delete') {
              include 'tani/dashboard-tani-delete.php';
            } elseif ($page == 'users') {
