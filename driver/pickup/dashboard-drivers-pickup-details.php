...
>
  ...
  <div class="section-content section-dashboard-home" data-aos="fade-up">
    <div class="container-fluid">
      ...
      <?php 
        $transactionMain = query("SELECT * FROM transactions 
        INNER JOIN users ON transactions.user_id = users.id_user 
        INNER JOIN tani ON transactions.tani_id = tani.id_tani
        WHERE id_transaction = $idTransaction")[0];
      ?>
      ...
      <div class="dashboard-content store-cart">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="150">
          ...
          <div class="col-6" style="font-size: 12px;">
              ...
              <div class="card-body">
                <a>
                 Nama : <?= $transactionMain["name_tani"]; ?>
              </a><br><a>
                 No Hp : <?= $transactionMain["phone_number"]; ?>
              </a><a><br>
                 Kecamatan : <?= $transactionMain["kecamatan"]; ?>
              </a>
              <h2> <?= $transactionMain["alamat"]; ?>
                  </h2>
              </div>
              </div>
              <div class="card mb-1">
