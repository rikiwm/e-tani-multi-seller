<?php 
$id = $_SESSION["tani"];
$user = query("SELECT * FROM tani WHERE id_tani = $id")[0];
      ...
      <ul class="navbar-nav d-none d-lg-flex ml-auto">
        <li class="nav-item dropdown">
          ...
          <img
            ...
            />
            <?php 
              $id_user = $_SESSION['tani'];
              $user = query("SELECT * FROM tani WHERE id_tani = $id_user")[0];
            ?>
            Hi, <?= $user["name_tani"]; ?>
          </a>
        ...
        <form action="" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-4">
              ...
              <?php if ($transactionMain['photo_transaction'] == '' OR $transactionMain['transaction_status']=='BELUM KONFIRMASI') : ?>
                <p class="text-danger font-weight-bold">Dana Belum Masuk </p>
              <?php else : ?>
                <p class="text-success font-weight-bold">Dana Telah Masuk Ke Admin </p>
                <p class="text-muted">Driver Akan Segera Mem pickup produk Anda!</p>
              <?php endif; ?>
