      ...
      <ul class="navbar-nav d-none d-lg-flex ml-auto">
        <li class="nav-item dropdown">
          ...
          >
            ...
            />
            <?php 
              $id_tani = $_SESSION['tani'];
              $tani = query("SELECT * FROM tani WHERE id_tani = $id_tani")[0];
            ?>
            Hi, <?= $tani["name_tani"]; ?>
          </a>
                    ...
                    <table class="table table-striped table-hover w-100" id="table">
                      ...
                      <tbody>
                        <?php 
                          $no = 1;
                          $id_tani = $_SESSION['tani'];
                          $galleries = query("SELECT * FROM products_galleries 
                            INNER JOIN tani ON products_galleries.tani_id = tani.id_tani
                          INNER JOIN products ON products_galleries.product_id = products.id_product
                          WHERE id_tani = $id_tani");
                        ?>
