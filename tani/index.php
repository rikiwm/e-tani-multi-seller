...
if (!isset($_SESSION["login"]) && !isset($_SESSION["tani"])) {
  header("Location: ../index.php");
} elseif (empty($_SESSION["tani"])) {
  $id = $_SESSION["tani"];
  $result = query("SELECT * FROM tani WHERE id_tani = $id")[0];
  header("Location: ../index.php");
}
...
<html lang="en">
  <head>
    ...
    <title>Dashboard | Supplier Pertanian Kota Solok</title>
      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          ...
          <div class="list-group list-group-flush">
            ...
            <a
              href="?page=products"
              class="list-group-item list-group-item-action<?= $page == 'products' ? ' active' : ''; ?>
               <?= $page == 'products-create' ? ' active' : ''; ?>
                <?= $page == 'products-details' ? ' active' : ''; ?>"
            >
              Products
            </a>
            <a
              href="?page=galleries"
              class="list-group-item list-group-item-action<?= $page == 'galleries' ? ' active' : ''; ?>
               <?= $page == 'galleries-create' ? ' active' : ''; ?>
                <?= $page == 'galleries-details' ? ' active' : ''; ?>"
            >
              Galleries
            </a>
            <a
              ...
              class="list-group-item list-group-item-action<?= $page == 'categories' ? ' active' : ''; ?>
               <?= $page == 'categories-create' ? ' active' : ''; ?>
                <?= $page == 'categories-details' ? ' active' : ''; ?>
                 <?= $page == 'categories-delete' ? ' active' : ''; ?>"
            >
              Categories
            </a>
            <div class="dropdown">
            ...
            <a
              ...
              <?= $page == 'profile-details' ? ' active' : ''; ?>"
            >
              Profile
            </a>
            <a
              href="?page=laporan"
              class="list-group-item list-group-item-action<?= $page == 'laporan' ? ' active' : ''; ?>"
            >
              Laporan
            </a>
            <a
        ...
        <div id="page-content-wrapper">
          ...
          if (isset($page)) {
            if ($page == 'dashboard') {
              include 'dashboard-tani.php';
            } elseif ($page == 'profile') {
              include 'profile/dashboard-petani-profile.php';
